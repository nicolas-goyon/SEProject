...
public class GridElement extends VBox {
    ...
    public GridElement(int id, Function<Integer, Void> callbackEdit, Function<Integer, Void> callbackDelete) {
        ...
        // Load the FXML file
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/SEApp/app/components/GridElement.fxml"));
    ...
    public GridElement(int id, Function<Integer, Void> callbackEdit, Function<Integer, Void> callbackDelete, Map<String, String> options) {
