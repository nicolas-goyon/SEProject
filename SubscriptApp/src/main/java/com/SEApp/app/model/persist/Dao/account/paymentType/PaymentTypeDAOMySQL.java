 ...
 * 
 */
public class PaymentTypeDAOMySQL extends PaymentTypeDAO {

    /**
     * @param mySQL
     */
    public PaymentTypeDAOMySQL(MySQL mySQL) {
        super(mySQL);
    }
    ...
    public PaymentType get(int id) throws SQLException {
        ...
        WhereOperand whereOperand = new WhereOperand(PaymentTypeSchema.ID, "=",  id);
        WhereOperand[] whereOperands = {whereOperand};
        Map<String, Object>[] res = db.read(PaymentTypeSchema.TABLE, columns, whereOperands);
